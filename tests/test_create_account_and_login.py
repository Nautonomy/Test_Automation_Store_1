...
class TestAccountCreation:
    ...
    def test_correct_form_fill(self, driver):
        ...
        assert driver.current_url == create_account_success_page.url_return()
    ...
    def test_incorrect_form_fill(self, driver):
        ...
        create_account_page.click_continue_button()
        assert create_account_page.error_message_visible()
...
class TestLogin:
    ...
    def test_login_correct(self, driver):
        ...
        assert driver.current_url == account_page.url_return()
